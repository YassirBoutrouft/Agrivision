...
export interface SeriesModule<SeriesType extends RequiredSeriesType = RequiredSeriesType, ChartType extends ChartTypes = ChartTypes> extends BaseOptionsModule<ChartType> {
    type: 'series';
