...
export declare const DEFAULT_INVERTED_BACKGROUND_COLOUR: string;
...
export declare const DEFAULT_NAVIGATOR_STROKE: string;
...
export declare const DEFAULT_ANNOTATION_COLOR: string;
