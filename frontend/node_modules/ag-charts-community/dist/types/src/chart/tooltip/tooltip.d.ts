...
export type TooltipPointerEvent<T extends TooltipEventType = TooltipEventType> = TooltipOffsets & {
    type: T;
};
...
export declare function tooltipContentAriaLabel(content: TooltipContent | string): string;
...
export declare class Tooltip extends BaseProperties {
     ...
     */
    show(boundingRect: DOMRect, canvasRect: DOMRect, meta: TooltipMeta, content?: TooltipContent | string | null, instantly?: boolean): void;
    hide(): void;
    private toggle;
