...
import { type ErrorBoundSeriesNodeDatum, type SeriesNodeDatum } from '../series/seriesTypes';
...
export declare class TooltipManager {
    ...
    updateTooltip(callerId: string, meta?: TooltipMeta, content?: TooltipContent | string): void;
